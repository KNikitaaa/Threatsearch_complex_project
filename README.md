...
## Настройка среды разработки
    ...
    Установка пакета
    remotes::install_github("https://github.com/KNikitaaa/Threatsearch_complex_project")
...
инфраструктуры. Проект может применяться в задачах сетевой аналитики,
threat intelligence и оценки устойчивости интернет-инфраструктуры.
