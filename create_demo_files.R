# Create proper demo data files for the internetstructure package
...
# Save all demo data as proper .rda files
save(demo_dbip_data, file = "data/demo_dbip_data.rda", compress = "gzip", version = 2)
save(demo_geo_data, file = "data/demo_geo_data.rda", compress = "gzip", version = 2)
save(demo_unified_data, file = "data/demo_unified_data.rda", compress = "gzip", version = 2)
save(demo_traceroute_data, file = "data/demo_traceroute_data.rda", compress = "gzip", version = 2)

message("Demo data files created successfully!")
