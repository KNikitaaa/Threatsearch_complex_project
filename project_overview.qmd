...
5. Трассировка (Traceroute Explorer): Интерактивная трассировка маршрутов
...
# Заключение
  ...
  Internet Structure Explorer предоставляет полный набор инструментов для исследования и анализа структуры глобального интернета. От сбора данных из публичных источников до интерактивной визуализации и контейнеризации - проект охватывает все аспекты анализа сетевой инфраструктуры. Проект может применяться в задачах сетевой аналитики, threat intelligence и оценки устойчивости интернет-инфраструктуры.
